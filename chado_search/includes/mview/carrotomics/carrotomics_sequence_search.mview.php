...
function chado_search_create_sequence_search_mview() {
  ...
  $sql = "SELECT DISTINCT
      ...
      WHERE AP.value IN ('reftrans', 'unigene', 'whole_genome', 'genome_assembly', 'genome_annotation', 'tripal_analysis_unigene', 'bulk_data', 'ncbi_data', 'transcriptome', 'other_transcripts')
